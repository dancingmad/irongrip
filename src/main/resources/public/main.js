...
var CoursepickerComponent = /** @class */ (function () {
    ...
    CoursepickerComponent.prototype.subscribeCourseUpdates = function () {
        var _this = this;
        this.translationService.getCourseSubscription().subscribe(function (courses) {
            _this.courses = courses;
            if (!_this.coursePick.selectedCourse) {
                _this.coursePick.selectedCourse = _this.courses[0];
                _this.changeCourse();
            }
        });
    };
...
module.exports = __webpack_require__(/*! /Users/thorstenreis/Documents/dev/irongrp/src/main/angular/mnemotica/src/main.ts */"./src/main.ts");
